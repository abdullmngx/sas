...
<div class="px-3 py-3">
    ...
    <form class="mt-4 pt-2" method="post" action="/login">
        ...
        <div class="mt-4 pt-3 text-center">
            <p class="text-muted mb-0">Don't have an account ? <a href="/signup" class="fw-semibold text-decoration-underline"> Signup Now </a> </p>
        </div>
